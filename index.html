<html>
   ...
   <body>
	...
	<p><label>Email Address:
               <input email = "email" type = "text" size = "30"
                  maxlength = "30">
            </label></p>
...
<head>
      ...
      <style type = "text/css">
         ...
         {
            position: relative;
            -webkit-animation: movingimage linear 15s 1s 2 alternate;
            -moz-animation: movingimage linear 15s 1s 2 alternate;
            animation: movingimage linear 15s 1s 2 alternate;
         }
         @-webkit-keyframes movingimage 
         {
            0%   {opacity: 0; left: 400px; top: 0px;}
            25%  {opacity: 1; left: 0px; top: 200px;}
            50%  {opacity: 0; left: 400px; top: 200px;}
            75%  {opacity: 1; left: 400px; top: 200px;}
            100% {opacity: 0; left: 400px; top: 0px;}
         }
   ...
   <body>
      <img src = "hl.png" width = "600" height = "400"
...
<head>
      ...
      div
      {
         ...
         background: -webkit-gradient(
            ...
            color-stop(15%, White), color-stop(50%, lightsteelblue 40%),
            color-stop(75%, navy) );
